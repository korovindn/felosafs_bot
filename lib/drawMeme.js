...
module.exports = {
    draw: async function (t, a, imgUrl) { //commets about this function u can find at felosafs-online-editor
        ...
        ctx.font = 'regular 15px Montserrat';
        str = "мем создал бот";
        ctx.fillText(str, 70, canvas.height - verticalOffsetAuthor - 85)
        str = "паблика фелосафы";
        ctx.fillText(str, 70, canvas.height - verticalOffsetAuthor - 70)
        str = "https://vk.com/felosafs";
        ctx.fillText(str, 70, canvas.height - verticalOffsetAuthor - 55)
